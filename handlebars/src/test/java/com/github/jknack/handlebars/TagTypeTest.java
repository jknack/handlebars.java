...
public class TagTypeTest extends AbstractTest {
  ...
  public void collectVar() throws IOException {
    assertSetEquals(
        Arrays.asList("a", "z", "k"),
        compile("{{#hello}}{{a}}{{&b}}{{z}}{{/hello}}{{k}}").collect(TagType.VAR));
  }

  @Test
  public void collectSubexpression() throws IOException {
    assertSetEquals(
        Arrays.asList("tag"), compile("{{vowels (tag)}}", helpers).collect(TagType.SUB_EXPRESSION));
  }
  ...
  public void collectAmpVar() throws IOException {
    assertSetEquals(
        Arrays.asList("b"),
        compile("{{#hello}}{{a}}{{&b}}{{z}}{{/hello}}{{k}}").collect(TagType.AMP_VAR));
  }
  ...
  public void collectTripleVar() throws IOException {
    assertSetEquals(
        Arrays.asList("tvar"),
        compile("{{{tvar}}}{{#hello}}{{a}}{{&b}}{{z}}{{/hello}}{{k}}").collect(TagType.TRIPLE_VAR));
  }
  ...
  public void collectSection() throws IOException {
    assertSetEquals(
        Arrays.asList("hello"),
        compile("{{#hello}}{{a}}{{&b}}{{z}}{{/hello}}{{k}}").collect(TagType.SECTION));
  }
  ...
  public void collectSectionWithSubExpression() throws IOException {
    assertSetEquals(
        Arrays.asList("tag"),
        compile("{{#hello}}{{vowels (tag)}}{{/hello}}", helpers).collect(TagType.SUB_EXPRESSION));
  }
