...
public class BlockTest extends AbstractTest {
  ...
  public void array() throws IOException {
    ...
    Object hash =
        $(
            "goodbyes",
            new Object[] {$("text", "goodbye"), $("text", "Goodbye"), $("text", "GOODBYE")},
            "world",
            "world");
    ...
    shouldCompileTo(
        string,
        $("goodbyes", new Object[0], "world", "world"),
        "cruel world!",
  ...
  public void emptyBlock() throws IOException {
    ...
    shouldCompileTo(
        string, hash, "cruel world!", "Arrays iterate over the contents when not empty");
  ...
  public void blockWithDeepNestedComplexLookup() throws IOException {
    ...
    Object hash =
        $("omg", "OMG!", "outer", new Object[] {$("inner", new Object[] {$("text", "goodbye")})});
  ...
  public void blockHelperPassingNewContext() throws IOException {
    ...
    shouldCompileTo(
        string, hash, helpers, "<form><p>Yehuda</p></form>", "Context variable resolved");
  }
  ...
  public void blockHelperPassingComplexContextPath() throws IOException {
    ...
    shouldCompileTo(
        string, hash, helpers, "<form><p>Harold</p></form>", "Complex path variable resolved");
  }
  ...
  public void blockInvertedSections() throws IOException {
    shouldCompileTo(
        "{{#people}}{{name}}{{^}}{{none}}{{/people}}", "{none: No people}", "No people");
  }
  ...
  public void blockInvertedSectionsWithEmptyArrays() throws IOException {
    shouldCompileTo(
        ...
        $("none", "No people", "people", new Object[0]),
        "No people");
  }
    ...
    Hash helpers =
        $(
            ...
            new Helper<List<Object>>() {
              @Override
              public Object apply(final List<Object> context, final Options options)
                  throws IOException {
                if (context.size() > 0) {
                  String out = "<ul>";
