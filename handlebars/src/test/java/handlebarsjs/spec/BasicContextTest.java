...
public class BasicContextTest extends AbstractTest {
  ...
  public void functionReturningSafeStringsShouldnotBeEscaped() throws IOException {
    ...
    shouldCompileTo(
        "{{awesome}}", hash, "&\"\\<>", "functions returning safestrings aren't escaped");
  }
  ...
  public void pathsWithHyphens() throws IOException {
    ...
    shouldCompileTo(
        "{{foo.foo-bar}}", "{foo: {foo-bar: baz}}", "baz", "Paths can contain hyphens (-)");
  ...
  public void thisKeywordInPaths() throws IOException {
    ...
    shouldCompileTo(
        string, hash, "helloHelloHELLO", "This keyword evaluates in more complex paths");
  }
